...
Test whether irregular heart rhythm (AF) can be reliably detected from **PPG alone** - without using ECG as a model input, since this is the realistic scenario for wearable devices that only have a PPG sensor, not an ECG lead.
